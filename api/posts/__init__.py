...
def main(req: func.HttpRequest) -> func.HttpResponse:
    try:
        ...
        query = 'SELECT p.id, p.type, p.digest, p.input, p.message, p.transcript, p.image, p.animations, p.name, p.language, p.nsfw, p.random, p.accesses, p.timestamp FROM Posts AS p WHERE '
