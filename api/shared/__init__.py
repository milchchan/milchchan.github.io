...
# 出力形式
出力形式は以下のJSONフォーマットとします。このフォーマット以外で出力しないでください。内容の重要度、面白さ、興味深さを評価しスコアをつけてください。まとめや宣伝や販促・キャンペーン系のような内容はスコアを低くつけてください。配列の長さが10件を超える場合は、日付が新しい順に並び替え上位10件にしてください。
```json
[{
    "language":  "ja",
    "content":  "<内容>",
