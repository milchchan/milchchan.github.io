...
```'''
TRANSFORM_USER_PROMPT = '内容から、ひとつの偏愛ポイントを異様な熱量で語り、露骨ではないえっちな意味に勘違いできる内容だったらついそっちに受け取ってしまう危うさも混ぜながら、読者が笑いながら共感するテンション高めで語る今日の話題を、文頭で一人称から始める形は多用せずに書いてください。'